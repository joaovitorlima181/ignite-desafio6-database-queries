...
export class UsersRepository implements IUsersRepository {
  ...
  async findUserByFullName({
    ...
    return this.repository.query("select * from users where LOWER(first_name) = LOWER($1) or LOWER(last_name) = LOWER($2)", [first_name, last_name]); // Complete usando raw query
  }
}
